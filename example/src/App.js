...
import { TERoute, TESwitch } from 'react-tec'
...
const App = (props) => {
	...
	return (
		<Layout>
			<TESwitch>
				<TERoute path="/" exact component={Home} />
				<TERoute path="/get-started" component={GetStarted} />
				<TERoute path="/components" component={Components} />
			</TESwitch>
			{/*<TEPanelWrapper>
				<TEPanel title="Testing React TEC">
					...
					<TEButton onClick={() => setPopupFormVisible(true)}>Show Popup Form</TEButton>
