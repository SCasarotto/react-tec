		...
		<Fragment>
			...
			<TEPanelWrapper>
				<TEPanel>
					...
					<p>
						React TEC is a React component library built and
						maintained by{' '}
						<a href="https://www.38thstreetstudios.com/">
							38th Street Studios
						</a>
						. These docs will provide you with simple get started
						instructions and detailed examples of every component in
						the library.
					</p>
					<h2>
					...
					<p>
						Use these instructions to get up and running with React
						TEC.
					</p>
					<h2>
					...
					<p>
						The components documentation is broken down into
						different components types to make it a bit easier to
						traverse.
					</p>
					<ul>
						<li>
							<Link to="/components/globals">Globals</Link> - App
							wrappers of some global contexts (navigation,
							popups, overlays, etc.)
						</li>
						<li>
							<Link to="/components/layout">Layout</Link> - Page
							layout components (page wrapper, side bar, title
							bar, etc.)
						</li>
						<li>
							<Link to="/components/navigation">Navigation</Link>{' '}
							- Navigational components (links, navbar, sidenav,
							etc.)
						</li>
						<li>
							<Link to="/components/form">Form</Link> - Form
							inputs of all shapes and sizes (Largest of all
							component types)
						</li>
						<li>
							<Link to="/components/popup">Popup</Link> - Simple
							popup (modal) components (network activity, alert,
							confirm, etc.)
						</li>
						<li>
