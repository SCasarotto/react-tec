...
export const TECheckboxInputSection = () => {
	return (
		<ComponentSection>
			...
			/>
			<p>
				A simple checkbox component. <Code>TECheckboxInput</Code> is
				simply a styled HTML <Code>{'<input type="checkbox">'}</Code>.
				All props are passed right through to the checkbox. Reference{' '}
				<a
