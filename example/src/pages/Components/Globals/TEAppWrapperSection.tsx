...
export const TEAppWrapperSection = () => {
	return (
		<ComponentSection>
			<ComponentTitle
				title="TEAppWrapper"
			...
			/>
			<p>
				<Code>TEAppWrapper</Code> is meant to be the single top level
				wrapping element you need. Having said that, it does contain a
				number of things. <Code>TEAppWrapper</Code> contain the
				following:
			</p>
			<Codeblock>
				{`<BrowserRouter>
	<TEScrollToTop>
		<TEThemeProvider theme={theme} globalStyles={globalStyles}>
			...
			<p>
				...
				. For all other components, please view thier given
				documentation page.
			</p>
			<p>
				As for props, the only props <Code>TEAppWrapper</Code> accepts
				are those that <Code>TEThemeProvider</Code> accepts.
			</p>
			<p>
				<Code>TEAppWrapper</Code> is implemented like the following in
				this project:
			</p>
			<PropsTable
				propArray={[
