...
export const TEThemeProviderSection = () => {
	return (
		<ComponentSection>
			<ComponentTitle
			...
			/>
			<p>
				<Code>TEThemeProvider</Code> is required to wrap any React TEC
				components because it sets up the styled-components theme used
				by all of them. Theming in React TEC is not fully flusuhed out
				but you can adjust some properties. By passing an object to prop{' '}
...
`}
			...
			<p>
				In addition to theme properties, you can add styles to the
				styled-components globalStyles. This can be done like the
				following:
			</p>
			<Codeblock>
				{`const globalStyles = \`
...
const Main = () => (
	<TEThemeProvider globalStyles={globalStyles}>
		<App />
			...
			<p>
				These additional styles will be placed at the bottom of the
				global styles allowing you to overwrite any above.
			</p>
		</ComponentSection>
	)
}
