...
const TESideNavbarSection = () => {
	return (
		<ComponentSection>
			...
			/>
			<p>
				<Code>TESideNavbar</Code> is the sidebar component you see to the left of this page.
				Below is the code for the left nav.
			</p>
			<PropsTable
				propArray={[
					{
					...
					},
					{
						prop: 'links',
						type: 'array',
						note: 'Array of links to be displayed. See following props',
					},
					{
						prop: 'links.title',
						type: 'string',
...
export default TESideNavbarSection
